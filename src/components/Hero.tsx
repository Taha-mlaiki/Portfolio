          ...
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20 animate-fade-in">
            ...
            <div className="relative group">
              ...
              <div className="absolute inset-0 rounded-full">
                ...
                <div className="absolute inset-[-10px] rounded-full bg-gradient-accent opacity-20 blur-xl group-hover:opacity-40 transition-opacity duration-500" style={{ animationDelay: '0.5s' }} />
              </div>
              ...
              <div className="relative">
                <Avatar className="w-72 h-72 lg:w-96 lg:h-96 border-4 border-primary/50 shadow-glow group-hover:border-secondary/50 transition-all duration-500">
                  ...
                  <AvatarFallback className="text-6xl bg-gradient-primary text-primary-foreground">FS</AvatarFallback>
                </Avatar>
            ...
            <div className="flex-1 text-center lg:text-left space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-primary/30 bg-primary/10 backdrop-blur-sm">
                  ...
                  <span className="text-sm text-primary font-semibold tracking-wider uppercase">Available for Opportunities</span>
                </div>
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl">
                Crafting innovative web solutions with modern technologies. Passionate about building scalable applications and exceptional user experiences.
              </p>
