...
const experiences = [
  {
    ...
    description: "Worked on an innovation project and contributed to various stages of development using Next.js and MongoDB.",
  },
  {
    title: "Student",
    company: "Youcode",
    ...
    description: "Learned web development fundamentals, focusing on Laravel for backend and React for dynamic frontends, with hands-on projects.",
  },
  {
    title: "Internship",
    ...
    description: "Integrated frontend and backend using Next.js, building scalable web apps with efficient API connections.",
  },
  {
    title: "Student",
    company: "Youcode",
    ...
    description: "Mastered MERN stack, including Next.js, NestJS, and Docker, focusing on microservices and modern workflows.",
  },
];

const Experience = () => {
  return (
    <section id="experience" className="py-24 px-6 bg-card/30 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl relative z-10">
        <div className="text-center mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-accent/30 bg-accent/10 backdrop-blur-sm">
            ...
            <span className="text-sm text-accent font-semibold tracking-wider uppercase">Journey</span>
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold">
            My <span className="bg-gradient-accent bg-clip-text text-transparent">Experience</span>
          </h2>
                    ...
                    <div className="flex-1 space-y-3">
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div className="space-y-1">
                          <h3 className="text-2xl font-bold group-hover:text-primary transition-colors">{exp.company}</h3>
                          <p className="text-secondary font-semibold">{exp.title}</p>
                        </div>
