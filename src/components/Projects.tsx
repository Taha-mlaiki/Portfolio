...
const projects = [
  ...
  },
  {
    ...
    description:
      "AI-powered content creation platform using GPT models for marketing copy and social media posts.",
  ...
  },
  {
    ...
    description:
      "Mobile-first fitness tracker with workout plans, nutrition tracking, and progress visualization.",
  ...
  },
  {
    ...
    description:
      "Business intelligence platform with customizable charts, reports, and data export features.",
